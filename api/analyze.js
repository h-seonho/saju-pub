  ...
  try {
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [{
        ...
        [필수 지침]
        1. 절대 마크다운 코드 블록(```)을 사용하지 마세요.
        2. 응답은 반드시 HTML 태그를 사용하여 구조화하세요. 각 섹션 제목은 <h4>, 내용은 <p> 태그를 사용하세요.
        3. "종합 사주 총평" 타이틀을 중복하지 마세요.
        4. 전문적이고 진중한 어조를 사용하세요.
        5. 다음 섹션 순서대로 작성하세요:
           <h4>종합 사주 총평</h4><p>...</p>
           <h4>초년운 및 성장기</h4><p>...</p>
           <h4>중년운 (사회적 성취)</h4><p>...</p>
           <h4>말년운 (재물과 안식)</h4><p>...</p>
           <h4>직장 및 사업운 (재물 모으는 비법 포함)</h4><p>...</p>
           <h4>대인관계 및 연애/결혼운</h4><p>...</p>
           <h4>건강 및 체질 조언</h4><p>...</p>`
      }, {
        role: "user",
